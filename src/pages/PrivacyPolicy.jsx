    ...
    return (
        <section className="py-14 md:py-24 px-3.5">
            <div className="2xl:max-w-[1440px] 3xl:max-w-[1540px] 4xl:max-w-[1720px] mx-auto">
                ...
                <h5 className="mb-3 font-semibold">Contact forms</h5>
                <h5 className="mb-2 font-medium">Cookies</h5>
                ...
                <h5 className="mb-2 font-medium">Embedded content from other websites</h5>
                <p className="mb-4">Articles on this site may include embedded content (e.g. videos, images, articles, etc.). Embedded content from other websites behaves in the exact same way as if the visitor has visited the other website. These websites may collect data about you, use cookies, embed additional third-party tracking, and monitor your interaction with that embedded content, including tracking your interaction with the embedded content if you have an account and are logged in to that website.</p>

                <h5 className="mb-3 font-semibold">Analytics</h5>
                <h5 className="mb-2 font-medium">How long we retain your data</h5>
                <p className="mb-4">If you leave a comment, the comment and its metadata are retained indefinitely. This is so we can recognize and approve any follow-up comments automatically instead of holding them in a moderation queue. For users that register on our website (if any), we also store the personal information they provide in their user profile. All users can see, edit, or delete their personal information at any time (except they cannot change their username). Website administrators can also see and edit that information.</p>

                <h5 className="mb-2 font-medium">What rights you have over your data</h5>
