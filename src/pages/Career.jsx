  ...
  return (
    <main className="text-primary">
      <section className="bg-[#D5EE7B] px-6 py-16 sm:py-20">
        ...
        <Link to='/' className="absolute top-6 left-12 z-[2]"><img src={logo} alt="Greengem" className="w-[120px] sm:w-[144px] mb-1 sm:mb-2" /></Link>
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-8 flex items-center justify-center gap-3 sm:gap-4">
            <span className="text-sm font-medium tracking-[0.2em]">SHARE IT TO</span>
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-2">
            {jobs.map((job) => (
              ...
              >
                ...
                <p className="text-sm leading-relaxed text-[#3D3D3D]">{job.summary}</p>
