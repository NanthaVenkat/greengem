...
const Teams = [
    {
        ...
        phara: 'A self-made millionaire and young entrepreneur, with multiple million $+ exits to investors now dedicated to building Green Gem.'
    },
    {
        id: 2,
        Image: nishtaImg,
...
export default function MeetMyTeam() {
    return (
        <section className="pt-14 md:pt-24 px-3.5">
            <div className="2xl:max-w-[1440px] 3xl:max-w-[1540px] 4xl:max-w-[1720px] mx-auto">
                <h2 className="text-primary text-4xl sm:text-5xl font-medium mb-4 sm:mb-5">Meet the team</h2>
                <p className="text-secondary text-xl sm:text-2xl max-w-2xl mb-5">Our team brings decades of renewable solar energy, asset management and construction.</p>
