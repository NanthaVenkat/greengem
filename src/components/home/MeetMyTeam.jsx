      ...
      <div className="sm:max-w-[90%] mx-auto">
        ...
        <div className="team-slider-wrap lg:px-10">
          <Swiper
            ...
            spaceBetween={30}
            className="mt-10 sm:mt-16 sm:px-12"
          >
            {Teams.map((team) => (
          ...
          <div className="flex items-center justify-center gap-6 sm:gap-8 mt-8 mb-4 xl:mb-0 w-full sm:w-1/2 xl:mt-14 mx-auto sm:mx-0 sm:ml-auto">
            <div className="team-scrollbar hidden sm:block flex-1 h-[3px] bg-gray-200 rounded-full"></div>

            <div className="flex gap-3 sm:gap-4 text-2xl sm:text-3xl mb-10 sm:mb-0">
              <button className="team-prev cursor-pointer border-2 w-[42px] h-[42px] sm:w-[50px] sm:h-[50px] flex items-center justify-center rounded-lg">
                &lt;
              </button>
              <button className="team-next cursor-pointer border-2 w-[42px] h-[42px] sm:w-[50px] sm:h-[50px] flex items-center justify-center rounded-lg">
                &gt;
              </button>
            </div>
          </div>
